...
/**
 * RestaurantController Class Doc Comment
 *
 * @category Class
 * @package  CiliPica\Controller
 * @author   OpenAPI Generator team
...
class RestaurantController extends Controller
{
    ...
    public function getMenuAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->getMenu($responseCode, $responseHeaders);
    ...
    public function placeOrderAction(Request $request)
    {
        ...
        // Deserialize the input values that needs it
        try {
            $body = $this->deserialize($body, 'CiliPica\Model\Order', $inputFormat);
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("CiliPica\Model\Order");
    ...
    {
        return $this->apiServer->getApiHandler('restaurant');
    }
}
